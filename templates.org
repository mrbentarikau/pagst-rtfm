...
Channel functions are covered in [[file:functions.org][functions]].
...
Message functions are covered in [[file:functions.org][functions]].
...
User functions are covered in [[file:functions.org][functions]].
...
Database functions are covered in [[file:functions.org][functions]].
** DBEntry
